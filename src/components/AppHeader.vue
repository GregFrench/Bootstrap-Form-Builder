...
<div>
        ...
        {{formatCode(code)}}
          ...
          <div v-for="field in this.$store.state.fields">
            ...
            <div v-if="field.type === 'address'">
              <div v-if="field.subfields[0].active === 1">
              <{{'div class="row"'}}>
              <div>
                <{{'div class="col-xs-12"'}}>
              </div>
              ...
              <div v-if="field.subfields[1].active === 1">
              <{{'div class="row"'}}>
              <div>
                <{{'div class="col-xs-12"'}}>
              </div>
              ...
              <div v-if="field.subfields[2].active === 1 || field.subfields[3].active === 1">
              <{{'div class="row"'}}>
              <div>
                <{{'div class="col-xs-6"'}}>
              </div>
              ...
              <div v-if="field.subfields[4].active === 1 || field.subfields[5].active === 1">
              <{{'div class="row"'}}>
              <div v-if="field.subfields[4].active === 1">
                <{{'div class="col-xs-6"'}}>
              </div>
              <div>
              ...
              <div v-if="field.subfields[5].active === 1">
                <{{'div class="col-xs-6"'}}>
              </div>
    ...
    <div class="code">
    <div v-for="(field, index) in this.$store.state.fields">
