...
describe('methods', () => {
  ...
  it('updateLabel() commits a mutation to update the label with target.value instead of target.innerText', () => {
    const label = 'New Label 4';
    const index = 0;

    methods.updateLabel.apply(store, [{ target: { value: label } }, index]);
